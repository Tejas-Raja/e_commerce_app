...
import 'package:adidas_app/components/clothes_tile.dart';
...
class _ShopPageState extends State<ShopPage> {
  ...
  void addClothesToCart(Clothes clothes) {
    ...
    //alert the user, clothing successfully added to the cart
    showDialog(
      context: context,
      ...
      builder: (context, value, child) => Column(
        children: [
          ...
          Padding(
            ...
            child: Text(
              'Discover our variety of limited edition hoodies',
